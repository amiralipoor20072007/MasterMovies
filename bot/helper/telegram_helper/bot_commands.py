...
class _BotCommands:
    def __init__(self):
        ...
        self.MultiZipTelegramLeechCommand = f'multizip_telegram_leech{CMD_INDEX}'
        self.MultiUnZipTelegramLeechCommand = f'multiunzip_telegram_leech{CMD_INDEX}'
        ...
        self.SetLastID = f'setlastfile{CMD_INDEX}'
