...
from bot import Premuim_app, bot, dispatcher, updater, botStartTime, IGNORE_PENDING_REQUESTS, LOGGER, Interval, INCOMPLETE_TASK_NOTIFIER, DB_URI, alive, app, main_loop
...
from .modules import authorize, list, cancel_mirror,oghatsharei, mirror_status, mirror, clone, watch, shell, eval, delete, count, leech_settings, search, rss, qbselect
...
'''
        ...
        sendMarkup('شما در گروه و چنل ربات عضو نیستید\nبرای استفاده از ربات در هردو عضو شوید :)', context.bot, update.message, reply_markup)
...
def main():
    ...
    help_handler = CommandHandler(BotCommands.HelpCommand,
                                  bot_help,  run_async=True)
    stats_handler = CommandHandler(BotCommands.StatsCommand,
                                   stats,  run_async=True)
